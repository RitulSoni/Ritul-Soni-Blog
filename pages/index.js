    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center py-16 md:py-24">
          ...
          {/* Quick Actions - Original Styled Buttons */}
        ...
        <div id="ritul-gpt-section" className="relative mb-16">
          ...
          <div className="relative p-8 md:p-12">
            ...
            <div className="text-center">
              <Link href="/ai-chat">
                <span className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-full hover:from-primary-600 hover:to-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
              ...
              <div className="mt-4 flex justify-center items-center space-x-6 text-sm text-gray-500 dark:text-gray-400">
                <div className="flex items-center space-x-1">
